...
namespace GEM.Model
{
	public class Task
	{
		...
		public Site UpdatedSurvey { get; set; } = (Site)Fetcher.Survey.Clone(); // When Fetcher signals to Tasker that new Geodata was just pulled from the API, Tasker class will update this property with the newer Fetcher.Survey property
